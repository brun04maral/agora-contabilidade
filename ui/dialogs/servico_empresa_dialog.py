...
class ServicoEmpresaDialog(BaseDialogMedium):
    def __init__(
        self,
        parent,
        db_session: Session,
        ...
        super().__init__(parent, title="Adicionar Serviço EMPRESA" if not item_id else "Editar Serviço EMPRESA", width=500, height=450)
    ...
    def create_widgets(self):
        ...
        ctk.CTkLabel(main, text="Serviço - LADO EMPRESA", font=ctk.CTkFont(size=16, weight="bold")).pack(pady=(0, 20))
        ...
        self.descricao_entry = ctk.CTkEntry(main, placeholder_text="Ex: Edição de vídeo", height=35)
        ...
        self.quantidade_entry = ctk.CTkEntry(quantidade_frame, placeholder_text="Ex: 2", height=35)
        ...
        self.dias_entry = ctk.CTkEntry(dias_frame, placeholder_text="Ex: 3", height=35)
        ...
        self.valor_entry = ctk.CTkEntry(main, placeholder_text="Ex: 100.00", height=35)
        ...
        ctk.CTkButton(btn_frame, text="Gravar", command=self.gravar, width=120, fg_color="#4CAF50", hover_color="#45a049").pack(side="right")
