# -*- coding: utf-8 -*-
"""
ServicoEmpresaDialog - Diálogo para adicionar/editar serviços EMPRESA em orçamentos
Dialog para o lado EMPRESA com campos: descrição, beneficiário (BA/RR), quantidade, valor_unitario, total
"""
...
class ServicoEmpresaDialog(ctk.CTkToplevel):
    """
    Diálogo para adicionar ou editar serviço do lado EMPRESA
    """
    ...
    def __init__(
        ...
        # Configurar janela
        self.title("Editar Serviço EMPRESA" if self.is_edit else "Adicionar Serviço EMPRESA")
    ...
    def create_widgets(self):
        ...
        header_label = ctk.CTkLabel(
            main_frame,
            text="💼 " + ("Editar Serviço EMPRESA" if self.is_edit else "Novo Serviço EMPRESA"),
    ...
    def save(self):
        ...
        try:
            if self.is_edit:
                ...
                self.item.dias = 1  # Serviço EMPRESA não usa dias
                ...
                novo_item = OrcamentoItem(
                    ...
                    dias=1,  # Serviço EMPRESA não usa dias
            ...
            self.db.commit()
            messagebox.showinfo("Sucesso", "Serviço EMPRESA guardado com sucesso!")
            self.destroy()
        except Exception as e:
            self.db.rollback()
            messagebox.showerror("Erro", f"Erro ao guardar serviço EMPRESA: {str(e)}")
