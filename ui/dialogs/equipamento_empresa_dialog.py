...
class EquipamentoEmpresaDialog(BaseDialogMedium):
    def __init__(
        self,
        parent,
        db_session: Session,
        ...
        super().__init__(parent, title="Adicionar Equipamento EMPRESA" if not item_id else "Editar Equipamento EMPRESA", width=500, height=450)
    ...
    def create_widgets(self):
        ...
        ctk.CTkLabel(main, text="Equipamento - LADO EMPRESA", font=ctk.CTkFont(size=16, weight="bold")).pack(pady=(0, 20))
        ...
        self.descricao_entry = ctk.CTkEntry(main, placeholder_text="Ex: Câmara Sony FX3", height=35)
        ...
        self.quantidade_entry = ctk.CTkEntry(quantidade_frame, placeholder_text="Ex: 4", height=35)
        ...
        self.dias_entry = ctk.CTkEntry(dias_frame, placeholder_text="Ex: 2", height=35)
        self.dias_entry.pack(fill="x")

        ctk.CTkLabel(main, text="Valor Unitário (€):", font=ctk.CTkFont(size=13, weight="bold")).pack(anchor="w", pady=(0, 5))
        self.valor_entry = ctk.CTkEntry(main, placeholder_text="Ex: 50.00", height=35)
        self.valor_entry.pack(fill="x", pady=(0, 20))

        ctk.CTkLabel(main, text="ℹ️ Sem desconto no lado EMPRESA", font=ctk.CTkFont(size=11), text_color=("#666", "#999")).pack(pady=(0, 20))
        ...
        ctk.CTkButton(btn_frame, text="Gravar", command=self.gravar, width=120, fg_color="#2196F3", hover_color="#0b7dda").pack(side="right")
    ...
    def gravar(self):
        try:
            ...
            if not beneficiario_display:
                messagebox.showwarning("Aviso", "Beneficiário é obrigatória!")
                return
